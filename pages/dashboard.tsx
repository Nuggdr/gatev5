            ...
            {userData ? (
                <div className="bg-gray-800 p-10 rounded-lg shadow-2xl w-96">
                    ...
                    <button
                        ...
                        className={`w-full py-2 rounded ${buttonDisabled ? 'bg-gray-500' : 'bg-blue-500 hover:bg-blue-600'} text-white`}
                    >
                        {buttonDisabled ? 'Aguarde para ligar' : 'Ligar'}
                    </button>
                    {notification && (
                        <p className="mt-4 text-green-500 text-center">{notification}</p>
                    )}
                </div>
            ) : (
